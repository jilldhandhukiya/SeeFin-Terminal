...
const UniversalSearch = ({ onClose }: { onClose: () => void }) => {
        ...
        <div className="flex border-b border-gray-800/50">
          {[
            ...
            <button
              ...
              className={`flex-1 py-3 px-4 text-sm font-mono font-bold uppercase tracking-wider transition-colors cursor-pointer ${
                activeTab === tab.id 
